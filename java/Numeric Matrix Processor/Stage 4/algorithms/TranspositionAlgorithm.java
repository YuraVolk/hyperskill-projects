...
public class TranspositionAlgorithm implements ParametrizedMatrixAlgorithm<Integer> {
    ...
    private TranspositionDirection obtainTranspositionDirection(Integer number) {
        for (TranspositionDirection option : TranspositionDirection.values()) {
    ...
    public Matrix execute(Matrix firstMatrix, Integer method) {
        TranspositionDirection direction = this.obtainTranspositionDirection(method);
